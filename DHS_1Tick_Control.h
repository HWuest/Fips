...
class DHS_1Tick_Control {
  public:
    char tickChar[DHS_CHARSETNUM][32]={{' ','a','e','n','i','d','t','\x84' /*ä*/,'o','k','m','f','l','g','\x94' /*ö*/,'r','u','y','b','p','z','w','q','j','s', '*' /*ch*/,'x','v','\x81' /*ü*/,'c','h','#' /*sch*/},
                                       {' ','1','2','3','4','5','6','7'         ,'8','9','0','!','-',':','='         ,'&','/','(',')','<','>',',','.','?','{', '*' /*ch*/,'}','$','\x81' /*ü*/,'@','%','#' /*sch*/},
                                       {' ','A','E','N','I','D','T','\x8E' /*Ä*/,'O','K','M','F','L','G','\x99' /*Ö*/,'R','U','Y','B','P','Z','W','Q','J','S', '*' /*ch*/,'X','V','\x9A' /*Ü*/,'C','H','#' /*sch*/}};
